  ...
  <main class="main-panel">
    ...
    <div class="metric-grid">
      <div class="metric-card">
        ...
        <div class="subtext">Available tasks</div>
      </div>
      <div class="metric-card">
        <div class="label">Submitted</div>
        <div class="value"><?= $submittedCount ?></div>
        <div class="subtext">Completed uploads</div>
      </div>
      <div class="metric-card">
        <div class="label">Announcements</div>
        <div class="value"><?= $announcementsCount ?></div>
        <div class="subtext">Visible notices</div>
      </div>
      <div class="metric-card">
        <div class="label">Today</div>
        <div class="value"><?= date('d') ?></div>
        <div class="subtext"><?= date('l') ?></div>
      </div>
    </div>
