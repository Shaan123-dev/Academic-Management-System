...
$u = user();
$code = $u['role_code'] ?: digital_code('TCH', (int)$u['id']);
...
<div class="dashboard-shell">
    ...
    <main class="main-panel">
        <h1 class="page-title">Teacher Digital ID</h1>
        <div class="id-wrap">
            <div class="id-card" id="idCard">
                ...
                <div class="id-body">
                    ...
                    <div class="id-details">
                        <div class="id-highlight">Official Teacher ID</div>
                        <h2><?= e($u['name']) ?></h2>
                        <p><strong>Role:</strong> Teacher</p>
                        <p><strong>Course:</strong> <?= e($u['department'] ?: 'Not Assigned') ?></p>
                        <p><strong>Subject:</strong> <?= e($u['qualification'] ?: 'Not Assigned') ?></p>
...
<script>
    function downloadID() {
        ...
        html2canvas(element, {
            ...
            link.download = `Teacher_ID_${<?= json_encode($code) ?>}_${timestamp}.png`;
