        ...
        case 'marks':
            return {
                ...
                datasets: [{
                    ...
                    backgroundColor: STUDENT_CHART_COLORS.barColors.slice(0, dbData.subjectNames.length),
                    borderColor: '#ffffff',
                    borderWidth: 2,
                    borderRadius: 8,
                    barPercentage: 0.7
...
function updateStudentChart(chartType, trend, dbData) {
    ...
    if (chartType === 'doughnut') {
        ...
        if (trend === 'passfail') {
            ...
            bgColors = STUDENT_CHART_COLORS.barColors.slice(0, trendData.labels.length);
        } else {
            bgColors = STUDENT_CHART_COLORS.doughnutDefault.slice(0, trendData.labels.length);
        }
        chartData.datasets = [{
