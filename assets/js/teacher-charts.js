...
const TEACHER_CHART_COLORS = {
    ...
    barColors: ['#1B5E20', '#0D47A1', '#E65100', '#4A148C', '#004D40', '#B71C1C', '#F57F17', '#3E2723'],
    
    // Doughnut colors
    doughnutPassFail: ['#2E7D32', '#D32F2F'],
    doughnutDefault: ['#1B5E20', '#0D47A1', '#E65100', '#4A148C', '#004D40', '#B71C1C'],
        ...
        case 'marks':
            return {
                ...
                datasets: [{
                    ...
                    backgroundColor: TEACHER_CHART_COLORS.barColors.slice(0, dbData.subjectNames.length),
                    borderColor: '#ffffff',
                    borderWidth: 2,
                    borderRadius: 8,
                    barPercentage: 0.7
...
function updateTeacherChart(chartType, trend, dbData) {
    ...
    if (chartType === 'doughnut') {
        ...
        if (trend === 'passfail') {
            ...
            bgColors = TEACHER_CHART_COLORS.barColors.slice(0, trendData.labels.length);
        } else {
            bgColors = TEACHER_CHART_COLORS.doughnutDefault.slice(0, trendData.labels.length);
        }
        chartData.datasets = [{
